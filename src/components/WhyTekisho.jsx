...
const features = [
  {
    ...
    href: "/",
    cta: "Learn more",
    background: <div className="absolute -right-20 -top-20 opacity-10 bg-gradient-to-br from-green-500 to-transparent w-full h-full rounded-full" />,
  ...
  },
  {
    ...
    href: "/",
    cta: "Learn more",
    background: <div className="absolute -right-20 -top-20 opacity-10 bg-gradient-to-br from-purple-500 to-transparent w-full h-full rounded-full" />,
  ...
  },
  {
    ...
    href: "/",
    cta: "Learn more",
    background: <div className="absolute -right-20 -top-20 opacity-10 bg-gradient-to-br from-orange-500 to-transparent w-full h-full rounded-full" />,
      ...
      <div className="container max-w-[1280px] mx-auto px-8 relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-black mb-6  " style={{ letterSpacing: '-0.02em'}}>
            Why <span className="text-[#10B981]">Tekisho</span>?
          </h2>
