...
const ChartIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg {...props} width="16" height="16" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M1 13.5H14V14.5H1V13.5ZM1 1.5L4 4.5L6.5 2.5L10.5 7.5L14 3.5V11.5H1V1.5Z" fill="currentColor" />
  </svg>
);
...
export const CryptoCard = ({
  ...
  return (
    ...
    >
      {/* Left Panel — Gradient shows the pain/gain severity */}
      <div
        className={cn(
