...
export default function ThemeToggle() {
  ...
  return (
    <div className="fixed bottom-24 md:bottom-6 right-4 md:right-6 z-[999] flex flex-col items-end gap-3">
      {/* Theme option cards */}
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="bg-white rounded-2xl shadow-[0_8px_40px_rgba(0,0,0,0.14)] border border-[rgba(0,0,0,0.07)] p-3 w-[200px] sm:w-[220px]"
          >
            {/* Header */}
